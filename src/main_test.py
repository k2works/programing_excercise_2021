...
class FibonacciTest(unittest.TestCase):
    ...
    def test_large_number_recursive(self):
        self.assertEqual(self.fib.recursive(40), 102334155)

    def test_large_number_loop(self):
        self.assertEqual(self.fib.loop(40), 102334155)
...
class Fibonacci:
    def recursive(self, number, memo={}):
        ...
        memo[number] = self.recursive(
            number - 1, memo) + self.recursive(number - 2, memo)
        return memo[number]
